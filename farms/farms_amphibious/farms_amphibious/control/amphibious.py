...
from ..data.data import SpikingData
...
class JointMuscleController(AnimatController):
    ...
    def __init__(
            ...
            animat_options: SpikingControlOptions,
            animat_data: SpikingData,
...
# --------------------- [ SPIKING ] ---------------------
class SpikingController(JointMuscleController):
    """Spiking network"""
