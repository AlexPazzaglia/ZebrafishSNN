...
def sequential_processing(
    ...
    for feedback_mode in feedback_mode_vals:
        for leader_signal_str in leader_signal_str_list:
            data_plotting_2.plot_parameters_combination(
...
def main():
    ...
    leader_signal_str_list = [
        '2025-02-14T05:16:57.408809_WRONG_30s_continuous_036Hz_abdquickest_exp_11300_12400_scaled_025_large_grid_empirical_speed',
    ]
    ...
    results_root_folder = (
        ...
        'schooling_experimental_xy_grid_large_arena_theoretical_speed_passive_body_continuous'
    )
