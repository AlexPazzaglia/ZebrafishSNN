...
import data_loading_3 as data_loading
...
class SchoolingPlotting(BaseSchoolingPlotting):
    ...
    def _get_processes_names(self):
        ...
        self.process_folders = [
            [
                data_loading.get_process_folder_from_parameters(
                    self.process_parameters | {
                        'spawn_x'        : spawn_x,
                        'spawn_y'        : spawn_y,
                        'np_random_seed' : seed,
        ...
        self.save_file_root = data_loading.get_process_folder_nickname_from_parameters(
    ...
    def plot_histogram(self):
        ...
        max_density       = ( 0.20 *  self.n_seeds * self.n_iter_cons * self.n_spawn_y ) / total_data_points
