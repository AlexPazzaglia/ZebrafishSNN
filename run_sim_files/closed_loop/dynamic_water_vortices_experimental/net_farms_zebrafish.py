...
from brian2.units.allunits import pamp, second
...
class SalamandraSimulation(SnnExperiment):
    ...
    def step_function(self, curtime: VariableView) -> None:
        ...
        # Silence feedback
        # self.step_feedback_toggle( curtime, 0.0 * second, active= False )
        # self.step_feedback_toggle( curtime, 5.0 * second, active= True )
