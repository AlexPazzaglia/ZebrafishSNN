...
def main():
    ...
    ##############################################################
    print('Running closed loop simulations with varying speed')
    ...
    ##############################################################
    print('Running closed loop simulations with varying frequency')
