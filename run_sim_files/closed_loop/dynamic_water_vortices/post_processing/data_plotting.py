...
PHASE_OFFSET = 0.9444444444444449 * np.pi
class BaseSchoolingPlotting:
    def __init__(
        ...
        self.ps_tag    = 'closed_loop' if feedback_mode else 'open_loop'
    ...
    def _get_folder_names(self):
        ...
        self.folder_names = [
            data_loading.get_folder_name_from_seed(seed)
    ...
    def _load_saved_simulation_data(self):
        ...
        with open(parameters_file, 'r') as f:
            ...
            for line in f:
                ...
                par_is_array = isinstance(par_value, np.ndarray)
                par_type     = (
                    type(par_value)
                    if not par_is_array
