...
class SchoolingPlotting(BaseSchoolingPlotting):
    ...
    def _get_processes_names(self):
        ...
        self.process_folders = [
            [
                data_loading_2.get_process_folder_from_parameters(
                    self.process_parameters | {
                        'spawn_x'        : spawn_x,
                        'spawn_y'        : spawn_y,
                        'np_random_seed' : seed,
        ...
        self.save_file_root = data_loading_2.get_process_folder_nickname_from_parameters(
